...
*All the wiring has been done using decent crimped connectors. The motherboard has a fuse to protect its components against failure.*
...
*The bed is not insulated - but in terms of electrical works - it has strain relief so you are unlikely to have electrical issues in the long run*
...
- Another example is that I like to fine tune a printer for a serial monitor like Pronterface. However, it is not possible to do so by default, because no commands give any output although the printer does respond to the commands:
...
- It is still possible to manually adjust the bed and the manual bed leveling uses tight springs
...
Flush cutters are not included, but you probably already have some. The instructions are quite terse, you need to read them carefully so you don't miss a step. Use Cura 4.6.x or higher - this will make for better quality prints.

## Conclusion

During this month of ownership I've been able to make plenty of prints. This printer was also my work horse, because my Creality CR-6 SE mainboard had failed is still waiting on a warranty replacement. 

This printer is not perfect. I've had some issues, but this isn't a bad printer if you remember that this printer only costs €176 euro. It has auto bed leveling, a decent amount of instructions, and you surely can get started quite easily. This printer is the best and most extensive feature set you are going to get for the price.